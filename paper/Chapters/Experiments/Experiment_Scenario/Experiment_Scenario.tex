...
\begin{figure*}[tb]
  ...
  \centering
    ...
    %\subfigure[Representation of the used workspace during optimized excitation.]{\includegraphics[width = 5.5cm]{Chapters/Experiments/Experimental_Design/TaskSpace.pdf}}
